...
```{r ProcRSE Parameters,  eval=FALSE}
    ProcRSElocation <- paste0(getwd(),"/Documents/Royal-Society-of-Edinburgh")
    ProcRSEdoclocation <- paste0(ProcRSElocation,"/Proceedings")
    ...
    ProcRSEoutputlocation <- paste0(getwd(),"/WordFlagDataFrames")
    ProcRSEWordFlagdfPath <- paste0(ProcRSEoutputlocation,"/","ProcRSEWordFlagdf.txt")
    ProcRSEDocumentSize <- 37796836
```
