...
##### **PROVISIONAL** "play", "player", "recreation", "work", "worker", and "labor" in *Proceedings at the Royal Society of London* (cORPUS DATA STILL NEEDS CLEANING. DIGITIZATION INFO BIASING RESULTS.)
...
```{r RoySocLon Parameters,  eval=FALSE}
    ...
    RoySocLondoclocation <- paste0(RoySocLonlocation,"/Documents")
