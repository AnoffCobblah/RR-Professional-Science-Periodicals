...
```{r DecBAASApp Parameters, eval=FALSE}
    ...
    BAASdoclocation <- paste0(BAASlocation,"/Documents")
...
#first we create a slightly different version of BAASFreqmat
      ...
      pl
      ggsave(file=paste0(getwd(),"/Applications/Victorian-Professional-Science-Writing/Reports-of-the-BAAS/Relationship.pdf"), device=pdf)
```
